/****************************************************************
* Air Bridge Software
* @file MissionController.cc
*
* @brief The file implements the mission controller functionalities 
* that inteface with the QML Planview and Flyview components. 
*  
* 
* @group MissionManager
* 
* @author Developer
* @version 1.1 03/01/2022 
...
VisualMissionItem* MissionController::insertOrderItem(QGeoCoordinate coordinate, int visualItemIndex, bool makeCurrentItem)
{
    qDebug()<<coordinate.latitude();
    //OrderDetails::orderinformation(coordinate,visualItemIndex,  makeCurrentItem);
    //orderinformation();
    return _insertSimpleMissionItemWorker(coordinate, MAV_CMD_NAV_WAYPOINT, visualItemIndex, makeCurrentItem);

}
//start
void MissionController::orderinformation(QGeoCoordinate coordinate)
{
    //OrderDetails *neworder = new(OrderDetails);
    neworder->setpickuppoint(coordinate);
    qDebug()<<"I am in MissionController::orderinformation";
    emit myorderChanged();

}
//end

/*void MissionController::displayPickupPoint ()
{

    QGeoCoordinate PickupPointCoordinate;
    PickupPointCoordinate = neworder->PickupPoint();
}*/
