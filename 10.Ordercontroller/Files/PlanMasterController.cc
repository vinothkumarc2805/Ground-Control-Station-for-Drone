/****************************************************************
* Air Bridge Software
* @file PlanMasterController.cc
*
* @brief The file implements the PlanMasterController functionality 
* that inteface with MissionController,GeoFenceController 
* and RallyPointController. 
*  
* 
* @group MissionManager
* 
* @author Developer
* @version 1.1 14/01/2022 
