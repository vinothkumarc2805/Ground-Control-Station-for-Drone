...
* Air Bridge Software
*
* @file PlanToolBarIndicators.qml
*
* @brief This file implements different indicators for PlanToolBar.
*
* @group Planview
*
* @author Author
*
*@file directory /AirBridge/src/PlanView/PlanToolBarIndicators.qml
*
...
Item {
    ...
    QGCLabel{
        //start
        text:"<b>Airbridge International</b>"
        //end
        y:20
        font.pointSize:ScreenTools.largeFontPointSize
