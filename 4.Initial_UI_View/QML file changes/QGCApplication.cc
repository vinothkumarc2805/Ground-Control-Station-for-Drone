...
*
* @brief This file implements and initiates all the QGC specific functionality.
*
* @group src
*
* @author Author
*
* @file directory /AirBridge/src/QGCApplication.cc
*
    ...
    , _runningUnitTests     (unitTesting)
{
    ...
    if (_runningUnitTests) {
        ...
        //start
        applicationName = QStringLiteral("Airbridge International");
        //end
