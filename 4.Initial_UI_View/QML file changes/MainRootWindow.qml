...
* Air Bridge Software
*
* @file MainRootWindow.qml
*
* @brief This file implements the UI top level application.
*
* @group src
*
* @author Author
*
*@file directory /AirBridge/src/ui/MainRootWindow.qml
*
* @version 1.1 25/11/2021
*
* Change request No: XXXX
*
* HLR ID : TBD
* LLR ID : TBD
 ****************************************************************************/
...
ApplicationWindow {
    ...
    function showTool(toolTitle, toolSource, toolIcon) {
        //start
        toolDrawer.backIcon     = "/qmlimages/back.svg"
        //end
    ...
    function showAnalyzeTool() {
        showTool(qsTr("Analyze Tools"), "AnalyzeView.qml", "/qmlimages/Analyzeview1.svg")
    }

    function showSetupTool() {
        showTool(qsTr("Vehicle Setup"), "SetupView.qml", "/qmlimages/vehiclesetup1.svg")
    }

    function showSettingsTool() {
        showTool(qsTr("Application Settings"), "AppSettings.qml", "/res/application1.svg")
    }
    //end
    //-------------------------------------------------------------------------
            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    SubMenuButton {
                        ...
                        //start
                        imageResource:      "/qmlimages/vehiclesetup1.svg"
                        //end
                        onClicked: {
                            if (!mainWindow.preventViewSwitch()) {
                    ...
                    SubMenuButton {
                        ...
                        //start
                        imageResource:      "/qmlimages/Analyzeview1.svg"
                        //end
                        imageColor:         qgcPal.text
                    ...
                    SubMenuButton {
                        ...
                        //start
                        imageResource:      "/res/application1.svg"
                        //end
                        imageColor:         qgcPal.text
