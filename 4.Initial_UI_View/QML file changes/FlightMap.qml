...
* @file FlightMap.qml
*
* @brief This file implements the Flight map display UI functionality.
*
*
* @group FlightMap
*
* @author Author
*
*@file directory /AirBridge/src/FlightMap/FlightMap.qml
*
...
Map {
    ...
    MapQuickItem {
        ...
        sourceItem: Image {
            id:             mapItemImage
            //start
            source:         isNaN(gcsHeading) ? "/res/Maplogo" : "/res/Maplogoarrow"
            //end
            mipmap:         true
            antialiasing:   true
