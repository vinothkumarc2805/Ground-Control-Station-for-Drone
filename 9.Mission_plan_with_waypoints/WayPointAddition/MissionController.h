...
public:
    ...
    Q_PROPERTY(QGeoCoordinate       fromCoordinate                  MEMBER _fromCoordinate              NOTIFY fromCoordinateChanged)
    ...
    Q_INVOKABLE VisualMissionItem* insertOrderItem(QGeoCoordinate coordinate, int visualItemIndex, bool makeCurrentItem = false);
    ...
    Q_INVOKABLE void orderinformation(QGeoCoordinate coordinate);

    //end
    //Q_INVOKABLE void displayPickupPoint();
...
signals:
    ...
    void fromCoordinateChanged              (void);
...
private:
    ...
    QGeoCoordinate              _fromCoordinate;
